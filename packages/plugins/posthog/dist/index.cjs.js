        ...
        const t = ['email', 'phone', 'address', 'ssn', 'credit_card', 'password', 'token', 'api_key', 'secret'],
            ...
            n = (s) => {
                ...
                for (const [r, a] of Object.entries(s)) {
                    ...
                    t.some((u) => l.includes(u)) ? (o[r] = '[REDACTED]') : (o[r] = n(a))
                }
                return o
            }
        return n(i)
...
class g {
    ...
    calculateChurnRisk(e, t) {
        const i = this.calculateChurnRiskFactors(e, t),
            ...
            u = Math.min(i.errorCount / 3, 1),
            m = Math.min(i.idleTime / 6e4, 1)
        return a * n + l * s + u * o + m * r
    }
    isHighChurnRisk(e, t) {
...
class v extends _.BasePlugin {
    ...
    async onInstall() {
        ;(this._initializePostHog(),
            (this._eventBuilder = new p(this.config)),
            (this._churnDetection = new g(this.config.churnTimeoutMs, this.config.churnRiskThreshold)),
            (this._performanceTracker = new f()),
    ...
    _handleChurnDetected(e, t, i) {
        ...
        if ((this._captureEvent('stepAbandoned', o), s)) {
            const r = this._eventBuilder.buildEventData(
                'highChurnRisk',
                { step_id: e.id, churn_risk_score: n, primary_risk_factor: this._getPrimaryRiskFactor(i) },
                e,
                t,
                void 0,
                this._getFlowInfo()
    ...
    _checkProgressMilestones(e) {
        ...
        ;(this.config.milestonePercentages || [25, 50, 75, 100]).forEach((n) => {
            if (t >= n && !this._progressMilestones.has(n)) {
                ...
                const s = this._eventBuilder.buildEventData(
                    'progressMilestone',
                    { milestone_percentage: n, actual_progress: t, steps_completed: this._getCompletedStepsCount(e) },
                    void 0,
                    e,
                    void 0,
                    this._getFlowInfo()
        ...
        this.config.experimentFlags &&
            this.config.experimentFlags.forEach((t) => {
                ...
                if (i) {
                    const n = this._eventBuilder.buildEventData(
                        'experimentExposed',
                        { experiment_flag: t, variant: i, user_id: e.currentUser?.id },
                        void 0,
                        e
                    )
...
const h = {
    ...
    w = { ...h, churnTimeoutMs: 18e4, excludePersonalData: !0, enableExperimentTracking: !0 },
    S = { ...h, eventPrefix: 'checkout_onboarding_', churnTimeoutMs: 6e5, milestonePercentages: [20, 40, 60, 80, 100] }
function y(c = {}) {
    return new v({ ...h, ...c })
}
exports.ChurnDetectionManager = g
exports.EventDataBuilder = p
exports.PerformanceTracker = f
exports.PostHogPlugin = v
exports.createPostHogPlugin = y
exports.defaultPostHogConfig = h
exports.ecommerceConfig = S
exports.saasConfig = w
