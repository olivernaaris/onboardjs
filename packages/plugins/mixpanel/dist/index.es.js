import { BasePlugin as g, AhaTracker as f } from '@onboardjs/core'
class m {
    constructor(e) {
        this.config = e
    }
        ...
        const t = ['email', 'phone', 'address', 'ssn', 'credit_card', 'password', 'token', 'api_key', 'secret'],
            ...
            n = (s) => {
                ...
                for (const [r, a] of Object.entries(s)) {
                    ...
                    t.some((u) => d.includes(u)) ? (o[r] = '[REDACTED]') : (o[r] = n(a))
                }
                return o
            }
        return n(i)
...
class S extends g {
    ...
    async _handleStepValidationFailed(e) {
        ...
        const s = this._eventBuilder.buildEventData(
            'stepValidationFailed',
            {
                step_id: t.id,
                validation_errors: n,
                error_count: Array.isArray(n) ? n.length : 1,
            },
            t,
            i,
            void 0,
    ...
    async _handleNavigationBack(e) {
        ...
        const s = this._eventBuilder.buildEventData(
            'navigationBack',
            {
                from_step_id: t.id,
                to_step_id: i.id,
                navigation_type: this._getNavigationType(t, i),
            },
            t,
            n,
            void 0,
    ...
    async _handleContextUpdate(e) {
        if (
            ...
            this.config.includeUserProperties && // Check if the user object has changed by comparing old and new
    ...
    _getPrimaryRiskFactor(e) {
        const t = {
            ...
            // Convert to ms equivalent
            errors: e.errorCount * 12e4,
            // Higher weight for errors
            idle: e.idleTime,
...
export {
    ...
    m as EventDataBuilder,
    S as MixpanelPlugin,
    w as PerformanceTracker,
    y as createMixpanelPlugin,
    p as defaultMixpanelConfig,
    E as ecommerceConfig,
    T as saasConfig,
}
